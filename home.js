...
const UI_TEXTS = {
    ja: {
        ...
        navWork: '作品',
        navContact: '連絡',
        eyebrow: '�?科教員志望 / 生�?�AI・教育・クリエイ�?ィブコー�?ィング',
        lead: '�?科�?�学びを「体験として�?解できる形」に設計する実習教員�?LLM・Web・ハ�?�ドウェアを横断し、インタラク�?ィブな教材とプロトタイプを制作して�?ます�?',
        viewWork: '作品を見る',
        readAbout: '自己紹介を読む',
        contactMe: '連絡する',
        factFocus: 'Focus',
        factFocusValue: '教育 x 生�?�AI x 体験型学�?',
        factStrength: 'Strength',
        factStrengthValue: '教材アイ�?アを動く試作に落とす力',
        factBase: 'Base',
        factBaseValue: '関西 / �?科教育',
        aboutKicker: 'About',
        aboutTitle: '学びを「触れる体験」に変え�?',
        aboutBody1: '�?科�?�実習教員として、「理解」を「触れて成立する体験」に変換することをテーマに活動して�?ます�?',
        aboutBody2: 'LLM・AIエージェントによる対話設計、Webベ�?�スのインタラクション、SpresenseやRaspberry Piを用�?たハードウェア開発を横断し、教材やプロトタイプを一貫して設計�?�実�?して�?ます�?',
        aboutBody3: 'ピクセルアートカメラ�?スト�?�リー�?リングAI、ジェスチャー操作などの試作を通じて、知識伝達にとどまらな�?学習環�?の可能性を検証して�?ます。�?数領域の技術を統合し、体験そのも�?�を設計できる点が強みです�?',
        skillsKicker: 'Skills',
        skillsTitle: '用途で使�?�?ける技�?',
        skillInteractionTitle: 'Interaction / Creative Coding',
        skillInteractionDesc: '����?競を受整する入り問',
        skillWebTitle: 'Web / Application',
        skillWebDesc: 'アプリケーションの構�?��概要�?�基用',
        skillAiTitle: 'AI / Agent',
        skillAiDesc: '生�?�AIと対話競覧をつくる変換',
        skillHardwareTitle: 'Hardware / IoT',
        skillHardwareDesc: '特�?世界とつながる技重への推数',
        skillDesignTitle: 'Design / Modeling',
        skillDesignDesc: '体験と要�?の質�?',
        skillInfraTitle: 'Infrastructure',
        skillInfraDesc: 'シス�?�?基用を�xえる基用囲??',
        skillCreativeTitle: 'Creative / Media',
        skillCreativeDesc: '観説と表現を䩟�?��る属対',
        workKicker: 'Work',
        workTitle: '学習体験につながる制作物',
        workPixel: 'カメラ表現と教材化�?�実�?',
        workSound: '音と身体操作�?�実�?',
        workAir: '空中操作による音楽体�?',
        workWater: '雨滴表現とインタラクション',
        workFog: '�?りガラスを拭く体験設�?',
        workMirror: '�?像�?�歪みを使った表現',
        workCloak: '光学迷彩の表現実�?',
        workGesture: 'ジェスチャーUIの実験集',
        achievementKicker: 'Achievement',
        achievementTitle: 'Google Cloud Generative AI Leader',
        achievementBody: '生�?�AIがビジネス�?学びをど�?変えるかを理解し、Google Cloud の生�?�AIサービスを活用するための基礎知識を身につけて�?ます�?',
        contactKicker: 'Contact',
        contactTitle: '教育と�?クノロジーの実験をご一緒できたら嬉し�?で�?',
        gestureHint: '背景の丸�?ノ�?�ドから作品へ移動できま�?',
